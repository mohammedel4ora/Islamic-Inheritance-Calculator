      ...
      schools: [
        {
          ...
          example: 'ترك الميت ما قيمته 60 ألف ريال. للزوج 30 ألفاً، للأم 10 آلاف، للإخوة لأم 20 ألفاً بالتساوي، والأشقاء صفر ريال.'
        },
        {
          ...
          example: 'ترك الميت 60 ألف ريال. للزوج 30 ألفاً، للأم 10 آلاف، وللأخوة لأم والأشقاء مجتمعين 20 ألفاً تُقسم بينهم جميعاً بالتساوي المطلق.'
        }
      ]
    },
    {
